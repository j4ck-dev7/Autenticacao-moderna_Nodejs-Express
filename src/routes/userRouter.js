...
router.get('/Oauth/google/get/url/signIn', slowDown.Oauth2UrlSlowDown, userController.getOauthUrlSignIn);
router.get('/Oauth/google/get/url/signUp', slowDown.Oauth2UrlSlowDown, userController.getOauthUrlSignUp);
...
router.post('/signIn', slowDown.signInSlowDown, rateLimit.autenticacaoLimit, validate.signInValidate, userController.signIn);
