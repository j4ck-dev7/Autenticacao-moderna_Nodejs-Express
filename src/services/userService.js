...
export const registerWithOauth = async (code, ip) => {
  ...
  logger.info("Usuário registrado com Oauth com sucesso", {
    usuarioId: user.subGoogle,
    ip,
  });
...
export const resetPassword = async (
  ...
  logger.info(
    "Senha do usuário atualizada com sucesso e sessões anteriores invalidadas",
    { usuarioId: id },
  );
...
export const validatePasswordResetToken = async (
  ...
  logger.info(
    "Senha do usuário resetada com sucesso e sessões anteriores invalidadas",
    {
      usuarioId: user._id,
      email,
      ip,
